...
function registerScripts()
{
	...
	wp_enqueue_script( 'getFormData', get_template_directory_uri() . '/app/js/vendor/jquery.form.min.js', ['jquery'],'', true );
	wp_enqueue_script( 'mainJs', get_template_directory_uri() . '/app/js/old/old.min.js', [ 'vueJs' ], '', true );
