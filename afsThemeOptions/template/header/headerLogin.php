<?php
$userImage = wp_get_attachment_image( getCusctomFieldFromUserPost()['userLogo']['attachment_id'], 'thumbnail', '',
	[
...
<?php get_template_part( 'afsThemeOptions/template/header/login/logoutBotton', '', $userImage ); ?>
