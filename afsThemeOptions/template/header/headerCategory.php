<div is="menuCategories" inline-template>
	<div class="col-md-2 position-relative" id="menuCategories">
		...
		<transition name="fade">
			<ul class="list-style-none bg-grey-light userMenu user-menu-category position-absolute	z-index-1 shadow-1 rounded-bottom py-3 text-nowrap"
			    @mouseleave="show=!show"
			    v-show="show">

				<?php foreach ( createCategoryBlock() as $key => $value ) : ?>
					<a href="<?php echo get_post_type_archive_link( $key ); ?>" class="nav-link text-dark">
