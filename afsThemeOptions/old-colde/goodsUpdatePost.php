<?php
add_action( 'wp_ajax_goodsUpdatePost', 'goodsUpdatePost' );
add_action( 'wp_ajax_nopriv_goodsUpdatePost', 'goodsUpdatePost' );
require_once( ABSPATH . 'wp-admin/includes/image.php' );
require_once( ABSPATH . 'wp-admin/includes/file.php' );
require_once( ABSPATH . 'wp-admin/includes/media.php' );

function goodsUpdatePost()
{
	global $form_error;
//	dump( $_POST );
//	dump( $_FILES );
	...
	if ( $_POST['action'] == 'goodsUpdatePost' )
	{
