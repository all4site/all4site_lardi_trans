var FileUploadWithPreview = function ()
{
	...
	var A, e = (function (A)
	{
		var e = function (A)
		{
			...
			function o(A, e, t, g)
			{
				var n = e && e.prototype instanceof l ? e : l, i = Object.create(n.prototype), B = new J(g || []);
			...
			var f = Object.getPrototypeOf, d = f && f(f(R([])));
			d && d !== t && g.call(d, i) && (m = d);
			var p = h.prototype = l.prototype = Object.create(m);
			...
			function y(A, t)
			{
				...
				if (g === e)
				{
					...
					{
						if (A.iterator.return && (t.method = "return", t.arg = e, y(A, t), "throw" === t.method)) return c;
			...
			return u.prototype = p.constructor = h, h.constructor = u, u.displayName = r(h, E, "GeneratorFunction"), A.isGeneratorFunction = function (A)
			{
				var e = "function" == typeof A && A.constructor;
				return !!e && (e === u || "GeneratorFunction" === (e.displayName || e.name))
			}, A.mark = function (A)
			{
				return Object.setPrototypeOf ? Object.setPrototypeOf(A, h) : (A.__proto__ = h, r(A, E, "GeneratorFunction")), A.prototype = Object.create(p), A
			}, A.awrap = function (A)
			{
				return {__await: A}
			}, v(S.prototype), S.prototype[B] = function ()
			{
				return this
			}, A.AsyncIterator = S, A.async = function (e, t, g, n, i)
			{
				void 0 === i && (i = Promise);
				var B = new S(o(e, t, g, n), i);
				return A.isGeneratorFunction(t) ? B : B.next().then(function (A)
				{
					return A.done ? A.value : B.next()
				})
			}, v(p), r(p, E, "Generator"), p[i] = function ()
			{
				return this
			}, p.toString = function ()
			{
			...
			}, A.keys = function (A)
			{
				...
				}, dispatchException: function (A)
				{
					...
					for (var i = this.tryEntries.length - 1; i >= 0; --i)
					{
						...
						{
							var r = g.call(B, "catchLoc"), o = g.call(B, "finallyLoc");
							if (r && o)
							{
			...
			key: "processFile", value: function (A)
			{
				...
				t.readAsDataURL(A), t.onload = function ()
				{
					...
					|| A.type.match("image/gif") ?
						e.imagePreview.style.backgroundImage = 'url("'.concat(t.result, '")') : A.type.match("application/pdf") ?
							e.imagePreview.style.backgroundImage = 'url("'.concat(e.successPdfImage, '")') : A.type.match("video/*") ?
					...
					e.input.multiple && (e.imagePreview.style.backgroundImage = 'url("'.concat(e.backgroundImage, '")'),
						A.type.match("image/png") || A.type.match("image/jpeg") ||
						A.type.match("image/gif") ? e.options.showDeleteButtonOnImages ? e.imagePreview.innerHTML += '' +
							'<div  class="custom-file-container__image-multi-preview" data-upload-token="'.concat(A.token, '"\n style="background-image: url(\'').concat(t.result, '\'); ">' +
								...
								'</span>' +
								'</div>\n ') :
							e.imagePreview.innerHTML += '\n  <div\n  class="custom-file-container__image-multi-preview" data-upload-token="'.concat(A.token, '" style="background-image: url(\'').concat(t.result, "'); \">" +
								"</div>") :
							A.type.match("application/pdf") ? e.options.showDeleteButtonOnImages ? e.imagePreview.innerHTML += '<div class="custom-file-container__image-multi-preview" data-upload-token="'.concat(A.token, '" style="background-image: url(\'').concat(e.successPdfImage, '\'); ">' +
								'<span class="custom-file-container__image-multi-preview__single-image-clear">' +
								'<span class="custom-file-container__image-multi-preview__single-image-clear__icon"' +
								' data-upload-token="').concat(A.token, '"\>&times;' +
								'</span>' +
								'</span></div>') :
								e.imagePreview.innerHTML += '<div class="custom-file-container__image-multi-preview" data-upload-token="'.concat(A.token, '" style="background-image: url(\'').concat(e.successPdfImage, "'); \"></div>") :
								A.type.match("video/*") ? e.options.showDeleteButtonOnImages ? e.imagePreview.innerHTML += '<div class="custom-file-container__image-multi-preview" style="background-image: url(\''.concat(e.successVideoImage, '\'); "data-upload-token="').concat(A.token, '">' +
									'<span class="custom-file-container__image-multi-preview__single-image-clear">' +
									'<span class="custom-file-container__image-multi-preview__single-image-clear__icon"     data-upload-token="').concat(A.token, '">&times;' +
									'</span></span></div>') :
									e.imagePreview.innerHTML += '<div  class="custom-file-container__image-multi-preview" style="background-image: url(\''.concat(e.successVideoImage, '\'); "  data-upload-token="').concat(A.token, '">' +
										'</div>') :
									e.options.showDeleteButtonOnImages ?
										e.imagePreview.innerHTML += '<div class="custom-file-container__image-multi-preview" style="background-image: url(\''.concat(e.successFileAltImage, '\'); " data-upload-token="').concat(A.token, '">' +
											'<span class="custom-file-container__image-multi-preview__single-image-clear">' +
											'<span class="custom-file-container__image-multi-preview__single-image-clear__icon"  data-upload-token="').concat(A.token, '" >&times;' +
											'</span>' +
											'</span>' +
						...
						return e.wrap(function (e)
						{
							for (; ;) switch (e.prev = e.next)
							{
								...
								case 2:
									...
									return r = void 0, o = void 0, e.prev = 5, e.next = 8, fetch(A[E], {mode: "cors"});
								case 8:
								...
								case 18:
									(C = new Blob([o], {type: o.type})).name = A[E].split("/").pop(), B.push(C);
								case 21:
									E++, e.next = 2;
									break;
								case 24:
